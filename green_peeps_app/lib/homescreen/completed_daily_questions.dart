...
class CompletedDailyQuestions extends StatefulWidget {
  ...
  const CompletedDailyQuestions(
      {Key? key, required this.quit, required this.answerMore})
      : super(key: key);

  @override
  _CompletedDailyQuestionsState createState() =>
      _CompletedDailyQuestionsState();
}
    ...
    return Container(
        ...
        child: Column(
          children: [
            const Spacer(),
            const Text(
              "Thank you for completing all of your daily questions.",
