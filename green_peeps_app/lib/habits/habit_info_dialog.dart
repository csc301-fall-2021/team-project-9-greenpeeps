...
class _HabitInfoDialogState extends State<HabitInfoDialog> {
  ...
  Widget Text1() {
    return Text(
      "In this section you'll see all of the habits recommended for you. "
  ...
  Widget Text2() {
    return Text(
      "When you see a habit that you want to adopt in your life, "
  ...
  Widget Text3() {
    return Text(
      "That's why we'll check in with you over the course of 14 days to see if you're having sucess with these habits. "
  ...
  Widget Text4() {
    return Text(
      "To make sure that you don't get overloaded, "
    ...
    return Dialog(
      ...
      child: Container(
          ...
          padding: EdgeInsets.symmetric(
              horizontal: _boxPadding + 10, vertical: _boxPadding),
          child: Column(
