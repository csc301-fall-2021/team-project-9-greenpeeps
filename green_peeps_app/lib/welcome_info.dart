      ...
      child: Column(
        children: [
          Container(
            ...
            child: Text(
              "GreenPeeps is on a mission to help people to develop more climate friendly habits. "
      ...
      child: Column(
        children: [
          Container(
            padding: const EdgeInsets.all(20),
            child: Text(
              "With your help, we hope to make a collective impact to avoid the worst outcomes of climate change. "
      ...
      child: Column(
        children: [
          Container(
            padding: const EdgeInsets.all(20),
            child: Text(
              "Oh... and on behalf of the GreenPeeps team, "
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    Navigator.popAndPushNamed(
                        context, '/init_questionnaire_intro');
                  },
                  child: const Text(
                    "Let's Go!",
                    style: TextStyle(
